...
|---------|---------|---------|---------|-----------|
| C0-F01 | 整车项目创建 | 创建整车项目，定义项目目标、范围、团队 | PM | S4 |
| C0-F02 | 项目计划制定 | 制定项目整体计划，包括里程碑、交付物 | PM | S4 |
| C0-F03 | 多PI规划 | 规划多个PI的交付内容和时间线 | PM | S4 |
| C0-F04 | 项目监控 | 监控项目进度、风险、问题 | PM | S4-S9 |
| C0-F05 | 版本规划 | 规划版本交付内容和时间 | PM | S4 |
| C0-F06 | 版本发布 | 管理版本发布流程和审批 | PM | S9 |
| C0-F07 | 节点基线管理 | 管理项目关键节点和基线 | PM | S4-S9 |
| C0-F08 | 项目报告 | 生成项目进度和健康度报告 | PM/管理层 | S4-S9 |

#### C1: 需求管理 (25个功能)

| 功能编号 | 功能名称 | 功能描述 | 主要角色 | 价值流阶段 |
|---------|---------|---------|---------|-----------|
| C1-F01 | Epic创建 | 创建Epic，定义业务需求 | PO | S1-S2 |
| C1-F02 | Epic优先级排序 | 对Epic进行优先级排序 | PO | S2 |
| C1-F03 | MoSCoW分类 | 对Epic进行MoSCoW分类 | PO | S2 |
| C1-F04 | Epic版本分配 | 将Epic分配到版本 | PO | S2 |
| C1-F05 | Feature创建 | 从Epic创建Feature | FO | S2 |
| C1-F06 | PRD编写 | 编写Feature的PRD文档 | FO | S2 |
| C1-F07 | SSTS拆解 | 将Feature拆解为SSTS | FO/SE | S2 |
| C1-F08 | 功能SSTS定义 | 定义功能规格SSTS-FO | FO | S2 |
| C1-F09 | 技术SSTS定义 | 定义技术规格SSTS-SE | SE | S2 |
| C1-F10 | 验收标准定义 | 定义Given-When-Then验收标准 | FO | S2 |
| C1-F11 | SSTS评审 | 评审SSTS规格 | FO/SE/SO | S2 |
| C1-F12 | SSTS分配到Module | 将SSTS分配到Module | SO | S2 |
| C1-F13 | MR创建 | 创建Module Requirement | SO | S2 |
| C1-F14 | MR规格细化 | 细化MR规格说明 | SO | S2 |
| C1-F15 | 接口设计 | 设计模块接口 | SO | S2 |
| C1-F16 | 依赖识别 | 识别MR之间的依赖关系 | SO | S2 |
| C1-F17 | MR就绪检查 | 检查MR是否就绪可开发 | SO/DL | S2 |
| C1-F18 | 需求变更管理 | 管理需求变更流程 | FO/SO | S1-S9 |
| C1-F19 | 需求追溯 | 追溯需求到代码/测试 | FO/QA | S1-S9 |
| C1-F20 | 需求状态管理 | 管理需求状态流转 | FO/SO | S1-S9 |
| C1-F21 | 需求搜索 | 搜索和查询需求 | 全角色 | S1-S9 |
| C1-F22 | 需求导入导出 | 导入导出需求数据 | PO/FO | S1-S2 |
| C1-F23 | 需求报告 | 生成需求统计报告 | PO/管理层 | S1-S9 |
| C1-F24 | 需求看板 | 可视化需求看板 | PO/FO | S1-S9 |
| C1-F25 | 需求评审会议 | 组织需求评审会议 | PO/FO/SE | S2 |

#### C2: 产品管理(资产) (31个功能)

| 功能编号 | 功能名称 | 功能描述 | 主要角色 | 价值流阶段 |
|---------|---------|---------|---------|-----------|
| C2-F01 | 资产搜索 | 搜索可复用资产 | SO | S3 |
| C2-F02 | 资产匹配 | 匹配需求与资产 | SO | S3 |
| C2-F03 | 复用评估 | 评估资产复用可行性 | SO | S3 |
| C2-F04 | 成熟度评估 | 评估资产成熟度L1-L5 | SO | S3 |
| C2-F05 | 兼容性评估 | 评估资产兼容性 | SO | S3 |
| C2-F06 | 复用成本评估 | 评估复用成本 | SO | S3 |
| C2-F07 | 复用决策 | 决策是否复用资产 | SO/PM | S3 |
| C2-F08 | 资产入库 | 将新资产入库 | SO | S3 |
| C2-F09 | 产品资产管理 | 管理产品级资产 | SO | S3 |
| C2-F10 | Feature资产管理 | 管理Feature级资产 | SO | S3 |
| C2-F11 | Module资产管理 | 管理Module级资产 | SO | S3 |
| C2-F12 | 资产版本管理 | 管理资产版本 | SO | S3 |
| C2-F13 | 资产依赖管理 | 管理资产依赖关系 | SO | S3 |
| C2-F14 | 资产标签管理 | 管理资产标签 | SO | S3 |
| C2-F15 | 资产分类管理 | 管理资产分类 | SO | S3 |
| C2-F16 | 资产文档管理 | 管理资产文档 | SO | S3 |
| C2-F17 | 资产使用统计 | 统计资产使用情况 | SO/管理层 | S3-S9 |
| C2-F18 | 资产复用率统计 | 统计资产复用率 | SO/管理层 | S3-S9 |
| C2-F19 | 资产成熟度统计 | 统计资产成熟度分布 | SO/管理层 | S3-S9 |
| C2-F20 | 资产收益分析 | 分析资产复用收益 | 管理层 | S3-S9 |
| C2-F21 | 资产推荐 | 智能推荐可复用资产 | SO | S3 |
| C2-F22 | 资产评分 | 对资产进行评分 | SO | S3 |
| C2-F23 | 资产评论 | 对资产进行评论 | SO/DEV | S3-S9 |
| C2-F24 | 资产订阅 | 订阅资产更新通知 | SO/DEV | S3-S9 |
| C2-F25 | 资产导入导出 | 导入导出资产数据 | SO | S3 |
| C2-F26 | 资产审核 | 审核资产入库申请 | SO/管理层 | S3 |
| C2-F27 | 资产下架 | 下架过时资产 | SO | S3-S9 |
| C2-F28 | 资产迁移 | 迁移资产到新环境 | SO | S3 |
| C2-F29 | 资产对比 | 对比不同资产 | SO | S3 |
| C2-F30 | 资产市场 | 资产市场展示 | SO/DEV | S3-S9 |
| C2-F31 | 资产仪表板 | 资产管理仪表板 | SO/管理层 | S3-S9 |
...
| C4-F05 | Task估算 | 估算Task工作量 | DEV | S5 |
| C4-F06 | Daily Standup | 每日站会 | DL/DEV | S5 |
| C4-F07 | 看板管理 | 管理任务看板 | DL/DEV | S5 |
| C4-F08 | Task状态流转 | 流转Task状态 | DEV | S5 |
| C4-F09 | 燃尽图 | 生成Sprint燃尽图 | DL | S5 |
| C4-F10 | 速率统计 | 统计团队速率 | DL | S5 |
| C4-F11 | 工时登记 | 登记工作时间 | DEV | S5 |
| C4-F12 | 工时统计 | 统计工时数据 | DL/PM | S5 |
| C4-F13 | 阻塞识别 | 识别任务阻塞 | DL | S5 |
| C4-F14 | 阻塞上报 | 上报阻塞问题 | DEV/DL | S5 |
| C4-F15 | 阻塞解决 | 解决阻塞问题 | DL/TPM | S5 |
| C4-F16 | Sprint Review | Sprint评审会议 | DL/DEV/PO | S5 |
| C4-F17 | Sprint Retro | Sprint回顾会议 | DL/DEV | S5 |
| C4-F18 | Sprint报告 | 生成Sprint报告 | DL | S5 |
| C4-F19 | 团队协作 | 团队协作工具 | DL/DEV | S5 |
| C4-F20 | 迭代仪表板 | 迭代执行仪表板 | DL | S5 |

#### C5: 测试验收 (29个功能)

| 功能编号 | 功能名称 | 功能描述 | 主要角色 | 价值流阶段 |
|---------|---------|---------|---------|-----------|
| C5-F01 | 测试计划 | 制定测试计划 | QA | S6 |
| C5-F02 | 测试用例设计 | 设计测试用例 | QA | S6 |
| C5-F03 | 测试用例评审 | 评审测试用例 | QA/FO | S6 |
| C5-F04 | 单元测试 | 执行单元测试 | DEV | S5-S6 |
| C5-F05 | 集成测试 | 执行集成测试 | QA | S6 |
| C5-F06 | 系统测试 | 执行系统测试 | QA | S7 |
| C5-F07 | 验收测试 | 执行验收测试 | QA/FO | S7 |
| C5-F08 | MIL验证 | 模型在环验证 | QA | S6 |
| C5-F09 | SIL验证 | 软件在环验证 | QA | S6 |
| C5-F10 | HIL验证 | 硬件在环验证 | QA | S7 |
| C5-F11 | 实车验证 | 实车测试验证 | QA | S7 |
| C5-F12 | 场景库管理 | 管理测试场景库 | QA | S6-S7 |
| C5-F13 | 测试数据管理 | 管理测试数据 | QA | S6-S7 |
| C5-F14 | 测试执行 | 执行测试 | QA | S6-S7 |
| C5-F15 | 测试自动化 | 自动化测试执行 | QA | S6-S7 |
| C5-F16 | 缺陷提交 | 提交缺陷 | QA | S6-S7 |
| C5-F17 | 缺陷分配 | 分配缺陷给开发 | QA/DL | S6-S7 |
| C5-F18 | 缺陷修复 | 修复缺陷 | DEV | S6-S7 |
| C5-F19 | 缺陷验证 | 验证缺陷修复 | QA | S6-S7 |
| C5-F20 | 缺陷关闭 | 关闭已修复缺陷 | QA | S6-S7 |
| C5-F21 | 缺陷统计 | 统计缺陷数据 | QA/管理层 | S6-S7 |
| C5-F22 | 测试覆盖率 | 统计测试覆盖率 | QA | S6-S7 |
| C5-F23 | 测试报告 | 生成测试报告 | QA | S7 |
| C5-F24 | 测试环境管理 | 管理测试环境 | QA | S6-S7 |
| C5-F25 | 测试工具管理 | 管理测试工具 | QA | S6-S7 |
| C5-F26 | 回归测试 | 执行回归测试 | QA | S6-S7 |
| C5-F27 | 性能测试 | 执行性能测试 | QA | S7 |
| C5-F28 | 安全测试 | 执行安全测试 | QA | S7 |
| C5-F29 | 测试仪表板 | 测试管理仪表板 | QA/管理层 | S6-S7 |

#### C6: DevOps交付 (26个功能)

| 功能编号 | 功能名称 | 功能描述 | 主要角色 | 价值流阶段 |
|---------|---------|---------|---------|-----------|
| C6-F01 | 代码提交 | 提交代码到仓库 | DEV | S5-S6 |
| C6-F02 | 代码审查 | Code Review | DEV | S5-S6 |
| C6-F03 | 分支管理 | 管理代码分支 | DEV/DL | S5-S6 |
| C6-F04 | 代码合并 | 合并代码分支 | DEV/DL | S5-S6 |
| C6-F05 | 代码扫描 | 静态代码扫描 | DevOps | S6 |
| C6-F06 | 编译构建 | 编译构建代码 | DevOps | S6 |
| C6-F07 | 单测执行 | 执行单元测试 | DevOps | S6 |
| C6-F08 | 质量门禁 | 质量门禁检查 | DevOps | S6 |
| C6-F09 | 制品生成 | 生成发布制品 | DevOps | S8 |
| C6-F10 | 制品入库 | 制品入库管理 | DevOps | S8 |
| C6-F11 | 制品版本管理 | 管理制品版本 | DevOps | S8 |
| C6-F12 | 制品依赖管理 | 管理制品依赖 | DevOps | S8 |
| C6-F13 | 制品晋级 | 制品环境晋级 | DevOps | S8 |
| C6-F14 | 发布审批 | 发布审批流程 | PM/管理层 | S9 |
| C6-F15 | 灰度发布 | 灰度发布部署 | DevOps | S9 |
| C6-F16 | 全量发布 | 全量发布部署 | DevOps | S9 |
| C6-F17 | 发布回滚 | 发布回滚 | DevOps | S9 |
| C6-F18 | 环境管理 | 管理部署环境 | DevOps | S6-S9 |
| C6-F19 | 配置管理 | 管理配置文件 | DevOps | S6-S9 |
| C6-F20 | 流水线配置 | 配置CI/CD流水线 | DevOps | S6 |
| C6-F21 | 流水线执行 | 执行CI/CD流水线 | DevOps | S6-S9 |
| C6-F22 | 流水线监控 | 监控流水线执行 | DevOps | S6-S9 |
| C6-F23 | 构建统计 | 统计构建数据 | DevOps/管理层 | S6-S9 |
| C6-F24 | 发布统计 | 统计发布数据 | DevOps/管理层 | S9 |
| C6-F25 | DevOps报告 | 生成DevOps报告 | DevOps/管理层 | S6-S9 |
| C6-F26 | DevOps仪表板 | DevOps仪表板 | DevOps/管理层 | S6-S9 |

#### C7: 分析与治理 (20个功能)

| 功能编号 | 功能名称 | 功能描述 | 主要角色 | 价值流阶段 |
|---------|---------|---------|---------|-----------|
| C7-F01 | 交付周期分析 | 分析交付周期 | PM/管理层 | S1-S9 |
| C7-F02 | 吞吐量分析 | 分析吞吐量 | PM/DL | S1-S9 |
| C7-F03 | 阻塞时间分析 | 分析阻塞时间 | PM/DL | S1-S9 |
| C7-F04 | 缺陷密度分析 | 分析缺陷密度 | QA/DL | S1-S9 |
| C7-F05 | 测试覆盖率分析 | 分析测试覆盖率 | QA | S1-S9 |
| C7-F06 | 缺陷逃逸率分析 | 分析缺陷逃逸率 | QA/管理层 | S1-S9 |
| C7-F07 | 需求追溯 | 需求追溯分析 | FO/QA | S1-S9 |
| C7-F08 | 变更影响分析 | 变更影响分析 | SE/SO | S1-S9 |
| C7-F09 | 缺陷根因分析 | 缺陷根因分析 | QA/DEV | S1-S9 |
| C7-F10 | 资产复用率统计 | 统计资产复用率 | SO/管理层 | S1-S9 |
| C7-F11 | 成熟度分布分析 | 分析成熟度分布 | SO | S1-S9 |
| C7-F12 | 复用收益分析 | 分析复用收益 | 管理层 | S1-S9 |
| C7-F13 | 管理层仪表板 | 管理层仪表板 | 管理层 | S1-S9 |
| C7-F14 | PM仪表板 | PM仪表板 | PM | S1-S9 |
| C7-F15 | Team仪表板 | Team仪表板 | DL/DEV | S1-S9 |
| C7-F16 | 自定义报告 | 自定义分析报告 | PM/管理层 | S1-S9 |
| C7-F17 | 数据导出 | 导出分析数据 | PM/管理层 | S1-S9 |
| C7-F18 | 趋势预测 | 预测趋势 | PM/管理层 | S1-S9 |
| C7-F19 | 对标分析 | 对标分析 | 管理层 | S1-S9 |
| C7-F20 | 度量体系管理 | 管理度量体系 | PM/管理层 | S1-S9 |
...
graph LR
    ...
    style TOTAL fill:#1565c0,stroke:#0d47a1,stroke-width:4px,color:#fff
```
